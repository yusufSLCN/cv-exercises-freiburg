    ...
    if args.transforms == 'basic':
        ...
        train_transforms = torchvision.transforms.Compose(
                [horizontal_flip(p=0.5),
                 random_resize_crop(size=32, scale=(1.0, 1.6)),
                 torchvision.transforms.ToTensor(),
                 torchvision.transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
        # END TODO #################
        ...
        train_transforms = torchvision.transforms.Compose(
                [torchvision.transforms.RandomHorizontalFlip(p=0.5),
                 torchvision.transforms.RandomResizedCrop(size=32, scale=args.scale),
                 torchvision.transforms.ToTensor(),
                 ])
        # END TODO #################
    else:
...
def main():
    ...
    for epoch in range(max_epochs):
        ...
        print(
                f"Validation of epoch {epoch + 1} complete. Loss {val_loss:.6f} accuracy {val_acc:.2%}")
        # START TODO #################
...
if __name__ == '__main__':
    ...
    #   or
    #   (2.2) spot the vs-code popup that says the application is now running and press 'open-in-local-browser'
